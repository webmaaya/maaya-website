          ...
          <div>
            ...
            <div className="section-header">
              ...
              <p className="section-sub">
                Enroll for free — fill a quick form!
              </p>
              ...
              {freeCourses.slice(0, 6).map(fc => (
                ...
                <div key={fc.id} className="free-course-card">
                  ...
                  <div className="free-course-card__body">
                    ...
                    <span className="free-course-card__badge">
                      FREE
                    </span>
                    ...
                    <p className="free-course-card__desc">
                      {fc.description}
                    </p>
            ...
            {freeCourses.length > 6 && (
              ...
              <div
                className="courses-section__footer"
                style={{ marginTop: 24 }}
              >
        ...
        {onlineCourses.length > 0 && (
          ...
          <div style={{ marginTop: 56 }}>
            ...
            <div className="section-header">
              ...
              <p className="section-sub">
                Learn from home with flexible online programs
              </p>
  ...
  />
        ...
        <div style={{ marginTop: 56 }}>
          ...
          {loading ? (
            ...
            >
              <p>
                No programs yet — add from Admin Panel:
